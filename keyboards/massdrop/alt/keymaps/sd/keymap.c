...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   _______, _______, _______, _______, U_T_AGCR,_______, _______, KC_MPRV, KC_MNXT, KC_MPLY, KC_MUTE,  \
...
void matrix_init_user(void) {
  ...
  // Sets default animation (see `led_setups` in `led_matrix_programs.c`)
  led_animation_id = 4;
};
